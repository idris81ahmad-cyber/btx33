        ...
        <div className="bg-white border border-[#D4C9B8] rounded-3xl overflow-hidden mb-10">
          <div className="px-6 py-4 border-b flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-[#6B5F54]">Manage customer orders and fulfillment</p>
            </div>
            <button onClick={loadOrders} className="px-4 py-2 text-sm border border-[#D4C9B8] rounded-xl hover:bg-white/50">
              Refresh
            </button>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-[#EDE6D9]">
                  {orders.map((order) => (
                    <tr key={order.orderNumber} className="hover:bg-[#F8F4EC]/60">
                      <td className="px-6 py-4 font-mono font-medium text-sm">{order.orderNumber}</td>
                      <td className="px-6 py-4">
                        <div className="font-medium">{order.fullName}</div>
                        <div className="text-xs text-[#6B5F54]">{order.email}</div>
                      </td>
                      <td className="px-6 py-4 text-xs text-[#6B5F54] hidden md:table-cell">
                      ...
                      <td className="px-6 py-4 text-xs text-[#6B5F54] hidden lg:table-cell">
                      ...
                      <td className="px-6 py-4">
                        <select
                          ...
                          className="input-premium text-xs rounded-xl px-3 py-1.5 w-full md:w-auto"
                        >
